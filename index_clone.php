...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				if(!click){
					...
					if(validateManualTrans()){
						...
						if(ftype == "unknown"){
							...
							car_no_plate	= no_plate_state+" "+plate_city+" "+plate_letter+" "+plate_number;
						}
			...
			$('body').delegate('#sel_car', 'keydown', function(){
				...
				if(keycode == '13'){
					...
					if(unknown != -1){
						...
						$('#in_car_no_plate_state').focus().select();
					}
				}
			});
			...
			// num num
			// num letter
			$('body').delegate('#in_car_no_plate_number', 'keydown', function(){
				var keycode = (event.keyCode ? event.keyCode : event.which);
				if(keycode == '13'){
...
<div id="wrapper">
	<div id="wrapper_content">
		<div id="display">			
			...
			<!-- daily rate display -->
			<div id="daily_rate_display">
				<!-- <div style="font-family: 'Open Sans';font-weight: 500;color: rgb(100,100,100);">
					<div style="display: inline-block;background-color: rgb(220,220,220);padding: 10px 20px;border-radius: 4px;border: 1px solid rgb(200,200,200);">PETROL <span style="font-weight: 700;">78.78</span></div>				
					<div style="margin-left: 10px; display: inline-block;background-color: rgb(220,220,220);padding: 10px 20px;border-radius: 4px;border: 1px solid rgb(200,200,200);">DIESEL <span style="font-weight: 700;">67.67</span></div>
				</div> -->
			</div>

			<!-- shift chooser -->
			<div style="margin-top: 20px;font-weight: 600;">
				<div style="display: inline-block;vertical-align: top;padding: 5px 10px;color: rgb(80,80,80);border-bottom: 3px solid orange;">SHIFT A</div>
				<div style="display: inline-block;vertical-align: top;padding: 5px 10px;color: rgb(140,140,140);">SHIFT B</div>
			</div>


			<!-- table display -->
			<div style="margin-top: 20px;">
				<div style="display: inline-block;vertical-align: top;width: 35%;height: 300px;margin-right: -4px;">
				...
				<div style="display: inline-block;vertical-align: top;width: 65%;height: 300px;background-color: orange;margin-right: -4px;">2</div>
			</div>
